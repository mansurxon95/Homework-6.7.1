...
import com.example.a6711.databinding.FragmentHomBinding
    ...
    override fun onCreateView(
       ...
       binding = FragmentHomBinding.inflate(inflater,container,false)
        ...
        binding.allBtn.setOnClickListener {
            findNavController().navigate(R.id.action_homFragment_to_allFragment)
        }

        binding.pasportBtn.setOnClickListener {
            findNavController().navigate(R.id.action_homFragment_to_pasportFragment)
        }
